    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          throw new Error(`Module "node:buffer" has been externalized for browser compatibility. Cannot access "node:buffer.${key}" in client code.`);
        }
      }
    }));
  }
...
var import_node_buffer4 = __toESM(require_node_buffer(), 1);
...
var import_node_buffer2 = __toESM(require_node_buffer(), 1);
...
async function fileTypeStream(readableStream, { sampleSize = minimumBytes } = {}) {
  const { default: stream } = await import("./node_stream-2FBJGZX3.js");
